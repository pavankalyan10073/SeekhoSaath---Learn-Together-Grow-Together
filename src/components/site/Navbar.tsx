        ...
        >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              className={`inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-crimson to-ember px-3 py-1.5 font-extrabold text-white shadow-md transition-all hover:-translate-y-0.5 hover:shadow-lg sm:px-4 sm:py-2 sm:text-sm ${user ? "text-[8px]" : "text-[11px]"}`}
            >
