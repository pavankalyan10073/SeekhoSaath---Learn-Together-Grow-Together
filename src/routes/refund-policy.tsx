  ...
  return (
    <main className="min-h-screen bg-background text-foreground pb-safe">
      ...
      <section className="container-px mx-auto max-w-3xl py-8 sm:py-10 md:py-14">
        ...
        <div className="mt-6 sm:mt-8 space-y-6 text-sm leading-relaxed text-foreground/90 sm:text-base sm:space-y-8">
          <section>
          ...
          <section>
            ...
            <p className="mt-2">For monthly subscriptions (Learner and Mastery plans):</p>
            <ul className="mt-2 list-disc space-y-1.5 ml-4 sm:ml-5">
          ...
          <section>
            ...
            <p className="mt-2">For individual session bookings:</p>
            <ul className="mt-2 list-disc space-y-1.5 ml-4 sm:ml-5">
          ...
          <section>
            ...
            <ol className="mt-2 list-decimal space-y-1.5 ml-4 sm:ml-5">
          ...
          <section>
            ...
            <p className="mt-2">The following are not eligible for refunds:</p>
            <ul className="mt-2 list-disc space-y-1.5 ml-4 sm:ml-5">
