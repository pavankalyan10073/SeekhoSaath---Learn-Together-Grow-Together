...
export async function saveUserProfile(uid: string, data: Record<string, unknown>): Promise<void> {
  const { error } = await supabase
    ...
    .upsert({
      ...
      profile_pic: data.profilePic as string,
      bio: data.bio as string,
      experience: data.experience as string,
      degree: data.degree as string,
      college: data.college as string,
      year_of_passing: data.yearOfPassing as string,
      specializations: data.specializations as string[],
      subjects_to_teach: data.subjectsToTeach as string[],
      charge_per_session: data.chargePerSession as string,
      teaching_mode: data.teachingMode as string,
      state: data.state as string,
      district: data.district as string,
      city: data.city as string,
      pin_code: data.pinCode as string,
      full_address: data.fullAddress as string,
      languages: data.languages as string[],
      aadhar_front: data.aadharFront as string,
      aadhar_back: data.aadharBack as string,
